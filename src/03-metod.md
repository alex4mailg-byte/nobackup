...
Утверждение, которое ничем нельзя опрокинуть, помечается как **(М)** или выносится в приложение. Там, где книга делает ставку — глава 22, приложение Ж, — прямо перечислены запрещённые манёвры отступления.
