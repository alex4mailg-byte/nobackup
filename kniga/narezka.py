...
# -*- coding: utf-8 -*-
"""
narezka.py — нарезка книги «Резервной копии нет» в исходник сайта mdBook.

Вход : K-teorii-bessmertiya-v-NN.md (единый файл книги)
Выход: src/ — 37 страниц, SUMMARY.md, nositeli.md, CNAME
"""
import re, sys, os

TITLE_FILES = {
    'К ТЕОРИИ БЕССМЕРТИЯ':  ('title.md',            None),   # до ревизии 34
    'РЕЗЕРВНОЙ КОПИИ НЕТ':  ('title.md',            None),   # с ревизии 34
